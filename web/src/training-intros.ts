...
export interface TrainingIntroStep extends TrainingIntroSituation {
  id: string;
  title: string;
  explanation: string;
  points: number;
  challenge: TrainingIntroSituation;
}
...
export function trainingIntroAnswer(situation: TrainingIntroSituation, kind: TrainingIntroKind): string[] {
  return kind === "pegging"
    ? [situation.playedCard].filter((card): card is string => Boolean(card))
    : [...situation.selected];
}
...
export const TRAINING_INTROS: Record<TrainingIntroKind, TrainingIntro> = {
  pegging: {
    ...
    steps: [
      { id: "pair", title: "Pair", explanation: "Play the same rank as the card just played. A pair scores 2 points. Here, your 6 joins the 6 already on the table.", hand: ["6d", "9c", "Jh", "Qs"], selected: [], played: ["6c"], playedCard: "6d", cutCard: "8h", countBefore: 6, points: 2, challenge: { hand: ["8d", "4c", "Jh", "Qs"], selected: [], played: ["8c"], playedCard: "8d", cutCard: "2h", countBefore: 8 } },
  ...
  discard: {
    ...
    steps: [
      ...
      { id: "fifteen", title: "Fifteen", explanation: "Any combination totaling 15 scores 2 points. Discard the 3 and one 8 to keep 5 and 10 together.", hand: ["5c", "10d", "As", "3h", "8c", "8d"], selected: ["3h", "8d"], requiredKeepCards: ["5c", "10d"], played: [], playedCard: null, cutCard: "2h", countBefore: 0, points: 2, challenge: { hand: ["6c", "9d", "2s", "8h", "Jc", "Kd"], selected: ["Jc", "Kd"], requiredKeepCards: ["6c", "9d"], played: [], playedCard: null, cutCard: "3h", countBefore: 0 } },
