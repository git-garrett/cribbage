...
- Crib logic: starts with the Schell own/opponent crib table, then adds a precomputed suited-discard lookup for `5 * P(two crib cards and cut match the discard suit)`.
