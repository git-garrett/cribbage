...
Environment=CRIBBAGE_RUST_PRIMARY_MODELS=${CRIBBAGE_RUST_PRIMARY_MODELS:-schell_table-peg_table-13.0,schell_table-peg_table-14.3}
...
Environment=CRIBBAGE_RUST_SHADOW_MODELS=${CRIBBAGE_RUST_SHADOW_MODELS:-schell_table-peg_table-13.0,schell_table-peg_table-14.3,schell_table-peg_table-14.8,schell_table-peg_table-14.8.1}
