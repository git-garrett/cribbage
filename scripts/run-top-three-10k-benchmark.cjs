...
const jobs = [
  {
    ...
    label: "Schell Table + Peg Table 4.0 vs Ras Table + Peg Table 4.0",
    workers: 4,
    oldMb: 768,
  },
  {
    ...
    label: "Schell Table + Peg Table 4.0 vs Schell Table + Peg 3.0",
    workers: 6,
    oldMb: 384,
  },
  {
    ...
    label: "Ras Table + Peg Table 4.0 vs Schell Table + Peg 3.0",
    workers: 4,
    oldMb: 384,
  },
];
