...
- For learning-data selection, asset refreshes, calibration or training, follow `docs/adr/0002-exclude-defunct-models-from-learning-data.md`; exclude all 15.x and 16.x decisions and audit inherited evidence.
